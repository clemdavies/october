...
use Clem\ExtendCore\ComponentBase;
...
class Library extends ComponentBase
{
    ...
    */
    public function onRun(){
        ...
        //\Cms\Classes\CombineAssets::combine(array('assets/stylesheet/library.css'),'/plugins/clem/feed/components/steam');

        /*
        echo "        <link href=\"";
        echo $this->env->getExtension('CMS')->themeFilter(array(0 => "assets/css/theme.less"));
        echo "\" rel=\"stylesheet\">;
        */
        ...
        Debug::dump($props);exit;
        Debug::dump(get_class($this->page));exit;
        */

        $this->addCss('/plugins/clem/feed/components/steam/assets/stylesheet/library.css');
        $this->addLess('/plugins/clem/feed/components/steam/assets/stylesheet/library.less');
     ...
     * @return void
     */
    public function addLessOLD($name, $attributes = [])
    {
